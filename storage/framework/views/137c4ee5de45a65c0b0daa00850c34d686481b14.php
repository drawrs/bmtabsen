...
<html>
  ...
  <!-- DataTables -->
  <link rel="stylesheet" href="<?php echo e(URL::to('admin/plugins/datatables/dataTables.bootstrap.css')); ?>">
  <!-- daterange picker -->
...
<!-- DataTables -->
<script src="<?php echo e(URL::to('admin/plugins/datatables/jquery.dataTables.min.js')); ?>"></script>
<script src="<?php echo e(URL::to('admin/plugins/datatables/dataTables.bootstrap.min.js')); ?>"></script>
<!-- SlimScroll -->
