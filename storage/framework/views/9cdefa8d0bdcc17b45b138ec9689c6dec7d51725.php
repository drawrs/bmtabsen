...
<table id="contoh" class="display">
  <thead>
      ...
      <tr bgcolor=white>
              ...
              <td align=center ><?php echo e($user->karyawan_id); ?></td>
              <td align=center ><?php echo e($user->detail->ktp); ?></td>
        <td align=left ><?php echo e($user->detail->nama); ?></td>
    
              <td align=left ><?php echo e($user->detail->jabatan->name); ?></td>
              <td align=left ><?php echo e($user->detail->alamat); ?></td>
